...
class Cell with _$Cell {
  ...
  const Cell(this.file, this.rank);
...
final expectedCells = <EnemyPawnConfiguration, List<Cell>>{
  EnemyPawnConfiguration(
    ...
    const Cell(CellFile.fileA, CellRank.rank8),
    const Cell(CellFile.fileB, CellRank.rank8),
    const Cell(CellFile.fileC, CellRank.rank8),
    const Cell(CellFile.fileD, CellRank.rank8),
    const Cell(CellFile.fileE, CellRank.rank8),
    const Cell(CellFile.fileA, CellRank.rank7),
    const Cell(CellFile.fileB, CellRank.rank7),
    const Cell(CellFile.fileC, CellRank.rank7),
    const Cell(CellFile.fileD, CellRank.rank7),
    const Cell(CellFile.fileE, CellRank.rank7),
    const Cell(CellFile.fileA, CellRank.rank6),
    const Cell(CellFile.fileB, CellRank.rank6),
    const Cell(CellFile.fileC, CellRank.rank6),
    const Cell(CellFile.fileD, CellRank.rank6),
    const Cell(CellFile.fileE, CellRank.rank6),
    const Cell(CellFile.fileA, CellRank.rank5),
    const Cell(CellFile.fileB, CellRank.rank5),
    const Cell(CellFile.fileC, CellRank.rank5),
    const Cell(CellFile.fileD, CellRank.rank5),
    const Cell(CellFile.fileE, CellRank.rank5),
    const Cell(CellFile.fileA, CellRank.rank4),
    const Cell(CellFile.fileB, CellRank.rank4),
    const Cell(CellFile.fileC, CellRank.rank4),
    const Cell(CellFile.fileD, CellRank.rank4),
  ],
  EnemyPawnConfiguration(
    pawnSideHasWhite: true,
    ...
    const Cell(CellFile.fileH, CellRank.rank8),
    const Cell(CellFile.fileG, CellRank.rank8),
    const Cell(CellFile.fileF, CellRank.rank8),
    const Cell(CellFile.fileE, CellRank.rank8),
    const Cell(CellFile.fileD, CellRank.rank8),
    const Cell(CellFile.fileH, CellRank.rank7),
    const Cell(CellFile.fileG, CellRank.rank7),
    const Cell(CellFile.fileF, CellRank.rank7),
    const Cell(CellFile.fileE, CellRank.rank7),
    const Cell(CellFile.fileD, CellRank.rank7),
    const Cell(CellFile.fileH, CellRank.rank6),
    const Cell(CellFile.fileG, CellRank.rank6),
    const Cell(CellFile.fileF, CellRank.rank6),
    const Cell(CellFile.fileE, CellRank.rank6),
    const Cell(CellFile.fileD, CellRank.rank6),
    const Cell(CellFile.fileH, CellRank.rank5),
    const Cell(CellFile.fileG, CellRank.rank5),
    const Cell(CellFile.fileF, CellRank.rank5),
    const Cell(CellFile.fileE, CellRank.rank5),
    const Cell(CellFile.fileD, CellRank.rank5),
    const Cell(CellFile.fileH, CellRank.rank4),
    const Cell(CellFile.fileG, CellRank.rank4),
    const Cell(CellFile.fileF, CellRank.rank4),
    const Cell(CellFile.fileE, CellRank.rank4),
  ],
  EnemyPawnConfiguration(
    ...
    const Cell(CellFile.fileA, CellRank.rank1),
    const Cell(CellFile.fileB, CellRank.rank1),
    const Cell(CellFile.fileC, CellRank.rank1),
    const Cell(CellFile.fileD, CellRank.rank1),
    const Cell(CellFile.fileE, CellRank.rank1),
    const Cell(CellFile.fileA, CellRank.rank2),
    const Cell(CellFile.fileB, CellRank.rank2),
    const Cell(CellFile.fileC, CellRank.rank2),
    const Cell(CellFile.fileD, CellRank.rank2),
    const Cell(CellFile.fileE, CellRank.rank2),
    const Cell(CellFile.fileA, CellRank.rank3),
    const Cell(CellFile.fileB, CellRank.rank3),
    const Cell(CellFile.fileC, CellRank.rank3),
    const Cell(CellFile.fileD, CellRank.rank3),
    const Cell(CellFile.fileE, CellRank.rank3),
    const Cell(CellFile.fileA, CellRank.rank4),
    const Cell(CellFile.fileB, CellRank.rank4),
    const Cell(CellFile.fileC, CellRank.rank4),
    const Cell(CellFile.fileD, CellRank.rank4),
  ...
  EnemyPawnConfiguration(
    ...
    const Cell(CellFile.fileH, CellRank.rank1),
    const Cell(CellFile.fileG, CellRank.rank1),
    const Cell(CellFile.fileF, CellRank.rank1),
    const Cell(CellFile.fileE, CellRank.rank1),
    const Cell(CellFile.fileD, CellRank.rank1),
    const Cell(CellFile.fileH, CellRank.rank2),
    const Cell(CellFile.fileG, CellRank.rank2),
    const Cell(CellFile.fileF, CellRank.rank2),
    const Cell(CellFile.fileE, CellRank.rank2),
    const Cell(CellFile.fileD, CellRank.rank2),
    const Cell(CellFile.fileH, CellRank.rank3),
    const Cell(CellFile.fileG, CellRank.rank3),
    const Cell(CellFile.fileF, CellRank.rank3),
    const Cell(CellFile.fileE, CellRank.rank3),
    const Cell(CellFile.fileD, CellRank.rank3),
    const Cell(CellFile.fileH, CellRank.rank4),
    const Cell(CellFile.fileG, CellRank.rank4),
